...
RUN apt-get update && \
    apt-get install -y dh-make gem2deb npm2deb wget git curl vim debmake build-essential libboost-all-dev cmake make debhelper
